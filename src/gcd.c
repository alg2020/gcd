...
else if(x%2==0&&y%2==0) return 2*binary_gcd_rec(x/2,y/2);
else if(x%2==0&&y%2!=0) return binary_gcd_rec(x/2,y);
else if(x%2!=0&&y%2==0) return binary_gcd_rec(x,y/2);
else if(x%2!=0&&y%2!=0&&y>=x) return binary_gcd_rec(x,(y-x)/2);
